...
namespace Stranne.VasttrafikNET.Tests.JsonParsing
{
    public class DepartureBoardJsonTest : BaseJsonTest
    {
        ...
        public static TheoryData TestParameters => new TheoryData<string, object>
        {
            ...
            { "DepartureBoard.Departures[0].DateTime", new DateTime(2016, 7, 16, 16, 50, 0) },
            ...
            { "DepartureBoard.Departures[1].DateTime", new DateTime(2016, 7, 16, 16, 50, 0) },
            ...
            { "DepartureBoard.Departures[2].DateTime", new DateTime(2016, 7, 16, 16, 50, 0) },
            ...
            { "DepartureBoard.Departures[3].DateTime", new DateTime(2016, 7, 16, 16, 50, 0) },
            ...
            { "DepartureBoard.Departures[4].DateTime", new DateTime(2016, 7, 16, 16, 51, 0) },
