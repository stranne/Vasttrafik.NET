...
namespace Stranne.VasttrafikNET.Tests.JsonParsing
{
    ...
    {
        protected override JsonFile JsonFile => JsonFile.ArrivalBoard;

        public static TheoryData TestParameters => new TheoryData<string, object>
        {
            { "ArrivalBoard.ServerDateTime", new DateTimeOffset(2016, 7, 16, 16, 48, 0, new TimeSpan(2, 0, 0)) },
            ...
            { "ArrivalBoard.Arrivals[2].DateTime", new DateTimeOffset(2016, 7, 16, 16, 50, 0, new TimeSpan(2, 0, 0)) },
            ...
            { "ArrivalBoard.Arrivals[3].DateTime", new DateTimeOffset(2016, 7, 16, 16, 50, 0, new TimeSpan(2, 0, 0)) },
