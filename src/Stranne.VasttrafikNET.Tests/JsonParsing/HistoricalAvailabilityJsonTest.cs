...
namespace Stranne.VasttrafikNET.Tests.JsonParsing
{
    public class HistoricalAvailabilityJsonTest :  BaseJsonTest
    {
        ...
        {
            { "", 5 },
            { "[0].DateTime", new DateTime(2016, 8, 1, 8, 0, 0) },
            { "[0].FreeSpaces",79 },
            { "[1].DateTime", new DateTime(2016, 8, 1, 8, 15, 0) },
            { "[1].FreeSpaces", 78 },
            { "[2].DateTime", new DateTime(2016, 8, 1, 8, 30, 0) },
            { "[2].FreeSpaces", 71 },
            { "[3].DateTime", new DateTime(2016, 8, 1, 8, 45, 0) },
            { "[3].FreeSpaces", 70 },
            { "[4].DateTime", new DateTime(2016, 8, 1, 9, 0, 0) },
            { "[4].FreeSpaces", 67 }
        };
