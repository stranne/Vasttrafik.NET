...
namespace Stranne.VasttrafikNET.Tests.JsonParsing
{
    public class TripJsonTest : BaseJsonTest
    {
        ...
        public static TheoryData TestParameters => new TheoryData<string, object>
        {
            ...
            { "TripList.Trips[0].Legs[0].Origin.RtTrack", null },
            ...
            { "TripList.Trips[0].Legs[0].Destination.Cancelled", false },
            { "TripList.Trips[0].Legs[0].Destination.Track", "C" },
            { "TripList.Trips[0].Legs[0].Destination.RtTrack", null },
            ...
            { "TripList.Trips[1].Legs[0].Booking", false },
            ...
            { "TripList.Trips[1].Legs[0].Night", false },
            ...
            { "TripList.Trips[1].Legs[0].Origin.RtTrack", null },
            ...
            { "TripList.Trips[1].Legs[0].Destination.RtTrack", null },
            ...
            { "TripList.Trips[2].Legs[0].Kcal", null },
            ...
            { "TripList.Trips[2].Legs[0].PercentBikeRoad", null },
            ...
            { "TripList.Trips[2].Legs[0].Origin.RtTrack", null },
            ...
            { "TripList.Trips[2].Legs[0].Origin.DirectDateTime", null },
            ...
            { "TripList.Trips[2].Legs[0].Destination.RtTrack", null },
